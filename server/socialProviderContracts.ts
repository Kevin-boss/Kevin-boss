...
export type SocialProviderContract = {
  ...
  oauth: { authorizationUrl: string; tokenUrl: string; scopes: string[]; requiresPkce: boolean; exchangeAdapterReady: boolean };
...
export const socialProviderContracts: Record<SocialPlatform, SocialProviderContract> = {
  youtube: {
    ...
    oauth: { authorizationUrl: "https://accounts.google.com/o/oauth2/v2/auth", tokenUrl: "https://oauth2.googleapis.com/token", scopes: ["https://www.googleapis.com/auth/youtube.upload"], requiresPkce: true, exchangeAdapterReady: false },
  ...
  tiktok: {
    ...
    oauth: { authorizationUrl: "https://www.tiktok.com/v2/auth/authorize/", tokenUrl: "https://open.tiktokapis.com/v2/oauth/token/", scopes: ["video.publish", "video.upload"], requiresPkce: true, exchangeAdapterReady: false },
  ...
  facebook: {
    ...
    oauth: { authorizationUrl: "https://www.facebook.com/v23.0/dialog/oauth", tokenUrl: "https://graph.facebook.com/v23.0/oauth/access_token", scopes: ["pages_show_list", "pages_read_engagement", "pages_manage_posts"], requiresPkce: false, exchangeAdapterReady: false },
  ...
  instagram: {
    ...
    oauth: { authorizationUrl: "https://www.facebook.com/v23.0/dialog/oauth", tokenUrl: "https://graph.facebook.com/v23.0/oauth/access_token", scopes: ["instagram_basic", "instagram_content_publish", "pages_show_list"], requiresPkce: false, exchangeAdapterReady: false },
  ...
  linkedin: {
    ...
    oauth: { authorizationUrl: "https://www.linkedin.com/oauth/v2/authorization", tokenUrl: "https://www.linkedin.com/oauth/v2/accessToken", scopes: ["w_organization_social"], requiresPkce: false, exchangeAdapterReady: false },
  ...
  x: {
    ...
    oauth: { authorizationUrl: "https://x.com/i/oauth2/authorize", tokenUrl: "https://api.x.com/2/oauth2/token", scopes: ["tweet.read", "tweet.write", "users.read", "offline.access"], requiresPkce: true, exchangeAdapterReady: false },
...
export function isSocialOAuthExchangeAdapterReady(platform: SocialPlatform) {
  return socialProviderContracts[platform].oauth.exchangeAdapterReady;
}
