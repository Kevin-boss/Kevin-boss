...
| Research | `creatorEmptyStates.test.tsx` | Project guard prevents action before selection | `Research.interaction.test.tsx` | `Research.interaction.test.tsx` | Citation and provenance behavior is covered by script and research contracts. |
| Media Library | `creatorEmptyStates.test.tsx` | Project guard prevents creation before selection | `AssetLibrary.interaction.test.tsx` | `AssetLibrary.interaction.test.tsx` | Rights classification is covered by `assetRights.integration.test.ts`. |
...
| Voice & Captions | `creatorEmptyStates.test.tsx` | Project guard prevents transcription before selection | `VoiceCaptions.interaction.test.tsx` | `VoiceCaptions.interaction.test.tsx` | Provider and ASR governance are covered at the server boundary. |
...
| AI Copilot | `creatorEmptyStates.test.tsx` | Action validation is procedure-tested | `Copilot.interaction.test.tsx` | `Copilot.interaction.test.tsx` | Whitelisted executable tools and approval rules are integration-tested. |
