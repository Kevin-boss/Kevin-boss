...
| Publishing approval boundary | `client/src/pages/Publishing.interaction.test.tsx` | A platform-specific scheduled publishing plan can be created without an official account, remains approval-required, and never implies direct posting success. |
